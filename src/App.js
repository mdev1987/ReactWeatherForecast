...
const App = () => {
  ...
  return (
    <div className="bg-gray-800 flex items-center justify-center py-7">
      <div className="outer-container flex flex-col lg:flex-row sm:w-3/4 w-11/12 rounded-3xl shadow-lg m-auto bg-gray-100">
        {/* form card section  */}
